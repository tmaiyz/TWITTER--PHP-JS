...
$sql2 = "SELECT username, name from user where id like '$id'";

$requette2 = $db->query($sql2);

$user2 = $requette2->fetch(PDO::FETCH_ASSOC);
            ...
            <div class="row">
                <div class="col-lg-3 col-md-2 col-2" id="navbar">
                    <div class="col-12" id="largeur">
                        ...
                        <div class="home1">
                            <div id="hover">
                                <a href="followers.php"><img id="home1" src="img/lists.png" alt="home"></a>
                ...
                <div class="col-lg-5 col-md-10 col-xs-10 col-sm-10 col-12" id="middle1">
                    <div class="col-12" id="middle">
                        <div class="quatre">
                            ...
                            <div class="deux">
                                <h4><a href="followers_user.php?id=<?=$id?>">Followers</h4></a>
                                <h5><a href="../Page_following/following_user.php?id=<?=$id?>">Following</a></h5>
                            </div>
                        </div>
                    </div>
                    ...
                    $sql = "SELECT token, avatar, follower_id, follow_id, user.name, user.username FROM follow INNER JOIN user ON follow.follow_id=user.id WHERE follower_id like '$id'";
                        ...
                        <div class="txt-followers">
                            ...
                            <div>
                                <form action="../Page_Recherche/profil_user.php" method="GET">
                                    <button type="submit" id="name_profil" class="margin2"><a href="../Page_Recherche/profil_user.php?id=<?= $value['follow_id'] ?>"><?= $value['name'] ?> </a> </button>
                                </form>
