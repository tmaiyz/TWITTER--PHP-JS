                ...
                <div class="col-lg-5 col-md-10 col-xs-10 col-sm-10 col-12" id="middle1">
                    <div class="col-12" id="middle">
                        <div class="quatre">
                            ...
                            <div class="deux">
                                <h4><a href="followers.php">Followers</h4></a>
                                <h5><a href="../Page_following/following.php">Following</a></h5>
                            </div>
                        </div>
                    </div>
                    ...
                    $sql = "SELECT token, avatar, follower_id, follow_id, user.name, user.username FROM follow INNER JOIN user ON follow.follow_id=user.id WHERE follower_id like '$IdSession'";
