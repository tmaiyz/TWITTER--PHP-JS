            ...
            <div class="col-lg-5 col-md-10 col-xs-10 col-sm-10 col-12" id="middle1">
                <div class="col-12" id="middle">
                    <div class="quatre">
                        ...
                        <div class="deux">
                                <h4><a href="../Page_Followers/followers_user.php?id=<?= $id ?>">Followers</h4></a>
                                <h5><a href="following_user.php?id=<?= $id ?>">Following</a></h5>  
                        </div>
                    </div>                       
                </div>
                ...
                <?php
                    ...
                    $sql = "SELECT token, avatar, follower_id, follow_id, user.name, user.username from follow JOIN user ON follow.follower_id = user.id where follow_id like '$id'";
